...
![1](./images/sharded-cluster-production-architecture.bakedsvg.svg)
...
shard server1 主节点	  shard server1 副节点	    hard server1 仲裁
...
rs.initiate(config)
```
其中_id : configs应与配置文件中配置的 replicaction.replSetName 一致，members 中的 host 为三个节点的 ip 和 port
